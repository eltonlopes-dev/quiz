...
// BANCO DE PERGUNTAS BÍBLICAS (20 itens)
const questions = [
    {
        question: 'Segundo a Bíblia, quem construiu a arca para sobreviver ao Dilúvio?',
        answers: [
    ...
    {
        question: 'Qual mar Moisés abriu, com a ajuda de Deus, para os hebreus passarem?',
        answers: [
            { text: 'Mar Morto', correct: false },
            { text: 'Mar Vermelho', correct: true },
            { text: 'Mar da Galiléia', correct: false },
            { text: 'Mar Mediterrâneo', correct: false }
        ]
    },
    {
        question: 'Quem foi traído por 30 moedas de prata?',
        answers: [
    ...
    {
        question: 'Qual desses homens sobreviveu a uma cova de leões?',
        answers: [
    ...
    {
        question: 'Segundo o Antigo Testamento, quem recebeu os Dez Mandamentos no Monte Sinai?',
        answers: [
    ...
    {
        question: 'Qual é o "Mandamento Resumido" que Jesus ensinou como o maior de todos?',
        answers: [
            { text: 'Não matarás', correct: false },
            { text: 'Amarás o teu próximo como a ti mesmo e a Deus sobre todas as coisas', correct: true },
            { text: 'Guardarás o sábado', correct: false },
            { text: 'Honrarás pai e mãe', correct: false }
        ]
    },
    // Adicionando mais 10 para completar 20
    {
        question: 'Quem foi a esposa de Abraão e mãe de Izaque?',
        answers: [
    ...
    {
        question: 'Qual foi o discípulo que negou Jesus três vezes antes do galo cantar?',
        answers: [
    ...
    {
        question: 'Quem escreveu a maioria das epístolas (cartas) no Novo Testamento?',
        answers: [
    ...
    {
        question: 'Qual homem bíblico era conhecido por sua força extraordinária, ligada ao seu cabelo?',
        answers: [
    ...
    {
        question: 'Quem foi vendido como escravo por seus próprios irmãos e depois tornou-se governador do Egito?',
        answers: [
    ...
    },
    {
        ...
        answers: [
            ...
            { text: 'Oseias', correct: false },
            { text: 'Jonas', correct: true }
        ]
    },
    {
        question: 'No Sermão da Montanha, Jesus ensina sobre as:',
        answers: [
            { text: 'Parábolas do Reino', correct: false },
            { text: 'Bem-aventuranças', correct: true },
            { text: 'Dez Pragas do Egito', correct: false },
            { text: 'Profecias do Fim', correct: false }
        ]
    },
    {
        question: 'Quem foi o rei conhecido por sua imensa sabedoria e por construir o primeiro Templo em Jerusalém?',
        answers: [
    ...
    {
        question: 'Quem foi lançado na fornalha ardente, mas não se queimou?',
        answers: [
            { text: 'Sadraque, Mesaque e Abede-Nego', correct: true },
            { text: 'Daniel e seus amigos', correct: false },
            { text: 'Elias e Eliseu', correct: false },
            { text: 'Moisés e Arão', correct: false }
        ]
    },
    {
...
// Lógica do Quiz (Inalterada, apenas IDs conferidos)
function startQuiz() {
